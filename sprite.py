...
class Gravity(pygame.sprite.Sprite):
    ...
    def get_random_gravity_data(self):
        ...
        return {"height": height, "time": t, "x_in": x_in, "x_out": x_out, "speed_x": speed_x, "speed_y": speed_y}
...
class Fruit(Gravity):
    fruits = {
        "apple": [(pw(0.1), ph(0.15)), (189, 227, 37)],
    ...
    def __init__(self, func, imgs, music, sprite_grop, orbit, score):
        ...
        self.rect.top = ph(1)
        self.speed = Speed()
        height, time, self.rect.centerx, x_out, self.speed.x, self.speed.y = self.get_random_gravity_data().values()
